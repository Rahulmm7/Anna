...
const SuccessPage = () => (
  ...
  <FallbackImage src={usImg} alt="Us Together" size={400} className="rounded-xl border-4 border-pink-400 mb-6" />
      ...
      <p className=" font-extrabold text-center text-black">Please send this picture to your cute pavam boy friend so that he knows how much you love him! and he is waiting for us to together again</p>
